...
\nico{
Inicialmente, avaliou-se a primeira etapa do estudo. A tabela \ref{table:irish_tanh_full} contém os resultados dos 32 modelos ajustados (identificados pela coluna \textit{idx}) para a base de dados Irish com, bem como os respectivos parâmetros e função de ativação \textit{tanh}. Além disso, as figuras \ref{fig:irish_tanh_pt1} e \ref{fig:irish_tanh_pt2} incluem a entropia cruzada calculada para cada época do ajuste. 
}
\rowcolors{2}{gray!25}{white}
\begin{table}
    \label{table:irish_tanh_full}
    \caption{\nico{Resultados referentes à base de dados Irish, que contém um $vocab\_size=64$. Os modelos foram ajustados com 2000 épocas, função perda entropia cruzada (\textit{train\_loss}) e função de ativação \textit{tanh}. A avaliação foi feita pela métrica perplexidade, tanto para o conjunto de treino (\textit{train\_perplexity}) quanto para o conjunto de teste (\textit{test\_perplexity}).}}
    \centering
    \resizebox{\linewidth}{!}{
        \begin{tabular}[t]{ccccccccc}
        \toprule
        idx & lstm\_units & embedding\_dim & learning\_rate & seq\_length & batch\_size & train\_loss & train\_perplexity & test\_perplexity \\
        \midrule
        1 & 256 & 256 & $10^{-3}$ & 50 & 4 & 1.403 & 4.066 & 3.124 \\
        2 & 256 & 256 & $10^{-3}$ & 50 & 16 & 1.296 & 3.654 & 4.205 \\
        3 & 256 & 256 & $10^{-3}$ & 200 & 4 & 1.017 & 2.766 & 2.946 \\
        4 & 256 & 256 & $10^{-3}$ & 200 & 16 & 0.973 & 2.646 & 3.054 \\
        5 & 256 & 256 & $10^{-5}$ & 50 & 4 & 2.964 & 19.385 & 24.709 \\
        6 & 256 & 256 & $10^{-5}$ & 50 & 16 & 3.060 & 21.319 & 17.931 \\
        7 & 256 & 256 & $10^{-5}$ & 200 & 4 & 2.963 & 19.359 & 20.401 \\
        8 & 256 & 256 & $10^{-5}$ & 200 & 16 & 2.939 & 18.889 & 18.316 \\
        9 & 256 & 512 & $10^{-3}$ & 50 & 4 & 1.370 & 3.936 & 3.143 \\
        10 & 256 & 512 & $10^{-3}$ & 50 & 16 & 1.235 & 3.438 & 4.034 \\
        11 & 256 & 512 & $10^{-3}$ & 200 & 4 & 0.982 & 2.671 & 2.835 \\
        12 & 256 & 512 & $10^{-3}$ & 200 & 16 & 0.897 & 2.452 & 3.050 \\
        13 & 256 & 512 & $10^{-5}$ & 50 & 4 & 2.846 & 17.227 & 20.247 \\
        14 & 256 & 512 & $10^{-5}$ & 50 & 16 & 2.922 & 18.584 & 15.660 \\
        15 & 256 & 512 & $10^{-5}$ & 200 & 4 & 2.815 & 16.694 & 17.581 \\
        16 & 256 & 512 & $10^{-5}$ & 200 & 16 & 2.801 & 16.453 & 15.721 \\
        17 & 1024 & 256 & $10^{-3}$ & 50 & 4 & 1.298 & 3.662 & 2.896 \\
        18 & 1024 & 256 & $10^{-3}$ & 50 & 16 & 1.011 & 2.748 & 3.999 \\
        19 & 1024 & 256 & $10^{-3}$ & 200 & 4 & 0.615 & 1.850 & 2.884 \\
        20 & 1024 & 256 & $10^{-3}$ & 200 & 16 & 0.223 & 1.249 & 4.689 \\
        21 & 1024 & 256 & $10^{-5}$ & 50 & 4 & 2.692 & 14.756 & 16.002 \\
        22 & 1024 & 256 & $10^{-5}$ & 50 & 16 & 2.778 & 16.082 & 13.960 \\
        23 & 1024 & 256 & $10^{-5}$ & 200 & 4 & 2.645 & 14.083 & 14.593 \\
        24 & 1024 & 256 & $10^{-5}$ & 200 & 16 & 2.649 & 14.137 & 13.348 \\
        25 & 1024 & 512 & $10^{-3}$ & 50 & 4 & 1.171 & 3.225 & 2.752 \\
        26 & 1024 & 512 & $10^{-3}$ & 50 & 16 & 0.662 & 1.938 & 4.381 \\
        27 & 1024 & 512 & $10^{-3}$ & 200 & 4 & 0.567 & 1.762 & 3.019 \\
        28 & 1024 & 512 & $10^{-3}$ & 200 & 16 & 0.196 & 1.216 & 4.381 \\
        29 & 1024 & 512 & $10^{-5}$ & 50 & 4 & 2.522 & 12.451 & 13.508 \\
        30 & 1024 & 512 & $10^{-5}$ & 50 & 16 & 2.526 & 12.500 & 11.069 \\
        31 & 1024 & 512 & $10^{-5}$ & 200 & 4 & 2.460 & 11.705 & 12.176 \\
        32 & 1024 & 512 & $10^{-5}$ & 200 & 16 & 2.404 & 11.062 & 10.387 \\
        \bottomrule
\end{tabular}
    }
\end{table}
\begin{figure}
    \label{fig:irish_tanh_pt1}
    \centering
    \includegraphics[width=\textwidth]{irish_tanh_1_16.pdf}
    \caption{Irish (parte 1)}
\end{figure}
\begin{figure}
    \label{fig:irish_tanh_pt2}
    \centering
    \includegraphics[width=\textwidth]{irish_tanh_17_32.pdf}
    \caption{Irish (parte 2)}
\end{figure}

\nico{
De maneira geral, observou-se certos padrões no comportamento da função perda com a modificação de cada covariável:
\begin{itemize}
    \item o aumento do \textit{batch\_size} tendeu a uma redução da perda, bem como em uma menor variabilidade a cada época. Tal comportamento é coerente, dado que há mais lotes utilizados no treino.
    \item \textit{seq\_length} tem comportamento e justificativa similares ao \textit{batch\_size}.
    \item é evidente o impacto de \textit{learning\_rate} na perda, posto que o aumento da perda está fortemente relacionada a uma taxa de aprendizagem menor. 
    \item não foi possível identificar modificação na perda ao alterarmos \textit{embedding\_dim}.
    \item o aumento do \textit{lstm\_units} tendeu a uma redução da perda. 
\end{itemize}
Por meio da matriz de correlação da figura \ref{fig:irish_tanh_corrMatrix}, pode-se corroborar os padrões identificados anteriormente. Destaque para a forte correlação negativa de $-0.87$ de \textit{learning\_rate}. Ademais, é interessante notar que \textit{batch\_size} apresentou uma (fraca) correlação positiva com a perplexidade, sendo um indicativo de tendência a sobreajuste do modelo.  
}
\begin{figure}
    \label{fig:irish_tanh_corrMatrix}
    \centering
    \includegraphics[width=\textwidth]{irish_tanh_corrMatrix.pdf}
    \caption{Irish (matriz de correlação)}
\end{figure}


\nico{
Na segunda etapa, os modelos selecionados, em ordem decrescente para perplexidade, foram $idx \in \{5,7,11,25\}$. Pela tabela \ref{fig:irish_tanh_vs_logit}, nota-se que as redes com função de ativação \textit{logit} tiveram um desempenho pior quando comparadas à \textit{tanh}. 
}
\rowcolors{3}{white}{gray!25}
\begin{table}
    \label{fig:irish_tanh_vs_logit}
    \caption{Irish: tanh vs logit}
    \centering
...
\begin{figure}
    ...
    \caption{Irish: tanh (esquerda) vs logit (direita)}
\end{figure}


\subsubsection{\nico{ABC Notation}}
\nico{
Assim como para a base de dados Irish, avaliou-se, inicialmente, a primeira etapa do estudo. A tabela \ref{table:abcnotation_tanh_full} contém os resultados dos 32 modelos ajustados (identificados pela coluna \textit{idx}) para a base de dados ABC Notation, bem como os respectivos parâmetros e função de ativação \textit{tanh}. Além disso, as figuras \ref{fig:abcnotation_tanh_pt1} e \ref{fig:abcnotation_tanh_pt2} incluem a entropia cruzada calculada para cada época do ajuste. 
}
\rowcolors{2}{gray!25}{white}
\begin{table}
    \label{table:abcnotation_tanh_full}
    \caption{\nico{Resultados referentes à base de dados ABC Notation, que contém um $vocab\_size=125$. Os modelos foram ajustados com 2000 épocas, função perda entropia cruzada (\textit{train\_loss}) e função de ativação \textit{tanh}. A avaliação foi feita pela métrica perplexidade, tanto para o conjunto de treino (\textit{train\_perplexity}) quanto para o conjunto de teste (\textit{test\_perplexity}).}}
    \centering
    \resizebox{\linewidth}{!}{
        \begin{tabular}[t]{ccccccccc}
        \toprule
        idx & lstm\_units & embedding\_dim & learning\_rate & seq\_length & batch\_size & train\_loss & train\_perplexity & test\_perplexity \\
        \midrule
        1 & 256 & 256 & $10^{-3}$ & 50 & 4 & 2.058 & 7.833 & 6.572 \\
        2 & 256 & 256 & $10^{-3}$ & 50 & 16 & 1.914 & 6.777 & 5.411 \\
        3 & 256 & 256 & $10^{-3}$ & 200 & 4 & 1.731 & 5.648 & 5.763 \\
        4 & 256 & 256 & $10^{-3}$ & 200 & 16 & 1.657 & 5.243 & 5.139 \\
        5 & 256 & 256 & $10^{-5}$ & 50 & 4 & 3.517 & 33.667 & 29.208 \\
        6 & 256 & 256 & $10^{-5}$ & 50 & 16 & 3.628 & 37.631 & 31.707 \\
        7 & 256 & 256 & $10^{-5}$ & 200 & 4 & 3.508 & 33.371 & 31.001 \\
        8 & 256 & 256 & $10^{-5}$ & 200 & 16 & 3.522 & 33.865 & 35.991 \\
        9 & 256 & 512 & $10^{-3}$ & 50 & 4 & 1.924 & 6.850 & 5.949 \\
        10 & 256 & 512 & $10^{-3}$ & 50 & 16 & 1.877 & 6.531 & 5.255 \\
        11 & 256 & 512 & $10^{-3}$ & 200 & 4 & 1.675 & 5.338 & 5.505 \\
        12 & 256 & 512 & $10^{-3}$ & 200 & 16 & 1.587 & 4.891 & 4.870 \\
        13 & 256 & 512 & $10^{-5}$ & 50 & 4 & 3.483 & 32.572 & 28.005 \\
        14 & 256 & 512 & $10^{-5}$ & 50 & 16 & 3.517 & 33.684 & 28.052 \\
        15 & 256 & 512 & $10^{-5}$ & 200 & 4 & 3.435 & 31.025 & 29.033 \\
        16 & 256 & 512 & $10^{-5}$ & 200 & 16 & 3.369 & 29.035 & 30.867 \\
        17 & 1024 & 256 & $10^{-3}$ & 50 & 4 & 1.782 & 5.945 & 5.690 \\
        18 & 1024 & 256 & $10^{-3}$ & 50 & 16 & 1.660 & 5.260 & 4.268 \\
        19 & 1024 & 256 & $10^{-3}$ & 200 & 4 & 1.487 & 4.423 & 4.507 \\
        20 & 1024 & 256 & $10^{-3}$ & 200 & 16 & 1.350 & 3.858 & 3.971 \\
        21 & 1024 & 256 & $10^{-5}$ & 50 & 4 & 3.452 & 31.557 & 27.038 \\
        22 & 1024 & 256 & $10^{-5}$ & 50 & 16 & 3.350 & 28.491 & 22.821 \\
        23 & 1024 & 256 & $10^{-5}$ & 200 & 4 & 3.387 & 29.567 & 26.320 \\
        24 & 1024 & 256 & $10^{-5}$ & 200 & 16 & 3.156 & 23.471 & 26.029 \\
        25 & 1024 & 512 & $10^{-3}$ & 50 & 4 & 1.767 & 5.856 & 5.611 \\
        26 & 1024 & 512 & $10^{-3}$ & 50 & 16 & 1.635 & 5.128 & 4.274 \\
        27 & 1024 & 512 & $10^{-3}$ & 200 & 4 & 1.361 & 3.899 & 4.342 \\
        28 & 1024 & 512 & $10^{-3}$ & 200 & 16 & 1.305 & 3.689 & 3.940 \\
        29 & 1024 & 512 & $10^{-5}$ & 50 & 4 & 3.366 & 28.959 & 22.080 \\
        30 & 1024 & 512 & $10^{-5}$ & 50 & 16 & 3.148 & 23.288 & 19.285 \\
        31 & 1024 & 512 & $10^{-5}$ & 200 & 4 & 3.210 & 24.780 & 22.511 \\
        32 & 1024 & 512 & $10^{-5}$ & 200 & 16 & 2.968 & 19.460 & 22.439 \\
        \bottomrule
        \end{tabular}
    }
\end{table}
\begin{figure}
    ...
    \centering
    \includegraphics[width=\textwidth]{abcnotation_tanh_1_16.pdf}
    \caption{ABC Notation (parte 1)}
\end{figure}
\begin{figure}
    \label{fig:abcnotation_tanh_pt2}
    \centering
    \includegraphics[width=\textwidth]{abcnotation_tanh_17_32.pdf}
    \caption{ABC Notation (parte 2)}
\end{figure}
...
\begin{itemize}
    ...
    \item o aumento do \textit{lstm\_units} tendeu a uma redução da perda. 
\end{itemize}
Por meio da matriz de correlação da figura \ref{fig:abcnotation_tanh_corrMatrix}, pode-se corroborar os padrões identificados anteriormente. Destaque para a forte correlação negativa de $-0.87$ de \textit{learning\_rate}. Ademais, é interessante notar que \textit{batch\_size} apresentou uma (fraca) correlação positiva com a perplexidade, sendo um indicativo de tendência a sobreajuste do modelo.  
}
\begin{figure}
    \label{fig:abcnotation_tanh_corrMatrix}
    \centering
    \includegraphics[width=\textwidth]{abcnotation_tanh_corrMatrix.pdf}
    \caption{ABC Notation (matriz de correlação)}
\end{figure}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item outras arquiteturad da RNN-LSTM
...
\nico{
Este trabalho visou a explorar um perfil de problemas visto na literatura, em que o foco resumia-se a composição musical em si (como em \citet{agarwala2017}) ou era um dos assuntos que complementavam o objetivo principal (caso de \citet{souza2018}). porém, com uma abordagem no contexto de modelagem. Mesmo fixando-se um único modelo, a modificação dos parâmetros e os testes com mais de uma base de dados permitiu identificar certos padrões comportamentais. Os resultados referentes a piora do desempenho das redes ao trocar a função de ativação \textit{tanh} para \textit{logit} podem ser exemplos do que foi comentado por \citet{goodfellow2016}, em que a primeira performa melhor do que a segunda no contexto de RNNs (no caso, utilizou-se uma LSTM). 
}
