...
\nico{
O processo de obtenção de dados, bem como os modelos utilizados nesse trabalho foram desenvolvidos na linguagem de programação \href{https://python.org/}{Python} e na IDE (\textit{Integrated Development Environment}) \href{https://code.visualstudio.com}{VS Code}. \pumi{Os pacotes utilizados neste trabalho foram os seguintes:}
\begin{itemize}
...
\nico{
O processo de modelagem foi feito utilizando 2000 épocas no ajuste do modelo, e segmentado em duas etapas. \sout{Ademais, cada modelo treinado tem a entropia cruzada como função de custo e a perplexidade como métrica de avaliação.} \pumi{Sugestão: Para o ajuste das redes utilizou-se a entropia cruzada como função custo e a perplexidade como métrica de avaliação.}  Na primeira etapa, foi fixada a função de ativação \textit{tanh} na camada LSTM, alterando-se os demais hiperparâmetros: \begin{itemize}
...
\end{itemize}
Consequentemente, foram ajustados 64 modelos, sendo 32 para cada base de dados. \pumi{A segunda etapa do experimento consistiu em trocar a função de ativação para a logit e avaliar se houveram mudanças na perplexidade dos modelos. Devido ao grande número de modelos, a alteração foi feita apenas para os dois piores e os dois melhores modelos em termos de perplexidade.}
\sout{Após isso, a segunda etapa envolveu selecionar os dois melhores e os dois piores modelos de cada base em relação à perplexidade para os dados de teste, alterar a função de ativação para sigmóide e avaliar se houve mudanças nas métricas. }
}
    % gerando músicas
...
\begin{enumerate}
    \item criar um novo modelo com os devidos hiperparâmetros, mas fixando o valor 1 em \textit{batch\_size}; 
...
\begin{table}
    \caption{\nico{Irish Results (+ bla bla bla dos resultados)}\pumi{vocabsize é fixo em 64 para todas as entradas desta tabela. logo não precisa estar numa coluna. Pode constar na caption. Sugiro ainda usar 3 casas depois da vírgula e diminuir o nome das colunas para diminuir o espaçamento entre colunas que está enorme. Use $10^{-3}$ e não 1e-03.  A organização das linhas está em termos de lstmunits. Sugiro que esta então seja a primeira coluna após idx, depois embeding que é a segunda coluna 'organizadora' e assim por diante. Aliás, idx é realmente uma coluna necessária?}}
    \centering
    \resizebox{\linewidth}{!}{
        \begin{tabular}[t]{ccccccccccc}
            \toprule
            idx & batch\_size & seq\_length & learning\_rate & vocab\_size & embedding\_dim & lstm\_units & train\_cross\_entropy\_loss & train\_perplexity\_exp & test\_cross\_entropy\_loss & test\_perplexity\_exp \\
            \midrule
            1 & 4 & 50 & 1e-03 & 64 & 256 & 256 & 1.40274 & 4.06633 & 1.13925 & 3.12443 \\
            2 & 16 & 50 & 1e-03 & 64 & 256 & 256 & 1.29574 & 3.65371 & 1.43617 & 4.20455 \\
            3 & 4 & 200 & 1e-03 & 64 & 256 & 256 & 1.01743 & 2.76609 & 1.08047 & 2.94607 \\
            4 & 16 & 200 & 1e-03 & 64 & 256 & 256 & 0.97303 & 2.64594 & 1.11635 & 3.05369 \\
            5 & 4 & 50 & 1e-05 & 64 & 256 & 256 & 2.96449 & 19.38487 & 3.20716 & 24.70870 \\
            6 & 16 & 50 & 1e-05 & 64 & 256 & 256 & 3.05959 & 21.31890 & 2.88653 & 17.93090 \\
            7 & 4 & 200 & 1e-05 & 64 & 256 & 256 & 2.96315 & 19.35892 & 3.01556 & 20.40057 \\
            8 & 16 & 200 & 1e-05 & 64 & 256 & 256 & 2.93856 & 18.88853 & 2.90777 & 18.31599 \\
            9 & 4 & 50 & 1e-03 & 64 & 512 & 256 & 1.37006 & 3.93558 & 1.14525 & 3.14322 \\
            10 & 16 & 50 & 1e-03 & 64 & 512 & 256 & 1.23492 & 3.43810 & 1.39474 & 4.03391 \\
...
\rowcolors{2}{gray!25}{white}
\begin{table}
    \caption{\nico{ABC Notation Results (+ bla bla bla dos resultados)}}
    \centering
    \resizebox{\linewidth}{!}{
        \begin{tabular}[t]{ccccccccccc}
            \toprule
            idx & batch\_size & seq\_length & learning\_rate & vocab\_size & embedding\_dim & lstm\_units & train\_cross\_entropy\_loss & train\_perplexity\_exp & test\_cross\_entropy\_loss & test\_perplexity\_exp\\
            \midrule
            1 & 4 & 50 & 1e-03 & 125 & 256 & 256 & 2.05834 & 7.83296 & 1.88278 & 6.57178 \\
            2 & 16 & 50 & 1e-03 & 125 & 256 & 256 & 1.91355 & 6.77709 & 1.68849 & 5.41129 \\
            3 & 4 & 200 & 1e-03 & 125 & 256 & 256 & 1.73134 & 5.64820 & 1.75154 & 5.76345 \\
            4 & 16 & 200 & 1e-03 & 125 & 256 & 256 & 1.65683 & 5.24264 & 1.63688 & 5.13912 \\
            5 & 4 & 50 & 1e-05 & 125 & 256 & 256 & 3.51653 & 33.66729 & 3.37443 & 29.20754 \\
            6 & 16 & 50 & 1e-05 & 125 & 256 & 256 & 3.62783 & 37.63112 & 3.45655 & 31.70746 \\
            7 & 4 & 200 & 1e-05 & 125 & 256 & 256 & 3.50768 & 33.37072 & 3.43402 & 31.00094 \\
            8 & 16 & 200 & 1e-05 & 125 & 256 & 256 & 3.52239 & 33.86516 & 3.58327 & 35.99121 \\
            9 & 4 & 50 & 1e-03 & 125 & 512 & 256 & 1.92420 & 6.84967 & 1.78314 & 5.94852 \\
            10 & 16 & 50 & 1e-03 & 125 & 512 & 256 & 1.87654 & 6.53090 & 1.65909 & 5.25455 \\
            11 & 4 & 200 & 1e-03 & 125 & 512 & 256 & 1.67485 & 5.33798 & 1.70574 & 5.50545 \\
            12 & 16 & 200 & 1e-03 & 125 & 512 & 256 & 1.58733 & 4.89069 & 1.58316 & 4.87032 \\
            13 & 4 & 50 & 1e-05 & 125 & 512 & 256 & 3.48344 & 32.57171 & 3.33239 & 28.00509 \\
            14 & 16 & 50 & 1e-05 & 125 & 512 & 256 & 3.51704 & 33.68446 & 3.33405 & 28.05186 \\
            15 & 4 & 200 & 1e-05 & 125 & 512 & 256 & 3.43480 & 31.02528 & 3.36844 & 29.03321 \\
            16 & 16 & 200 & 1e-05 & 125 & 512 & 256 & 3.36851 & 29.03519 & 3.42969 & 30.86696 \\
