...
\begin{enumerate}[label=(\roman*)]
  ...
  \item treinar a rede com um conjunto de treinamento (referencial). 
\end{enumerate}
...
% avaliar este ponto
% - fazer o paralelismo fala da literatura da RNA (o paralelo com a literatura estatística)
% - inserir a questão de RNA ser um modelo caixa preta, e a interpretabilidade é perdida, sendo o foco a predição
